...
describe("utils module", () => {
  ...
  describe("loadIgnoredDirectories", () => {
    it("should read from .gitignore file when it exists", () => {
      ...
      expect(fs.readFileSync).toHaveBeenCalledWith("/mock/cwd/.gitignore", "utf-8");
  ...
  describe("createOutputWriter", () => {
    ...
    it("should write classes to output file", () => {
      ...
      writer().writeDirect(mockClasses, ".classy", "output.html");
  ...
  describe("shouldProcessFile", () => {
    ...
    it("should return false for files in ignored directories", () => {
      ...
      const result = shouldProcessFile("node_modules/some/file.js", ["node_modules"], ".classy");
    ...
    it("should return false for virtual files", () => {
      const result = shouldProcessFile("virtual:some-module.js", ["node_modules"], ".classy");
    ...
    it("should return false for files in output directory", () => {
      const result = shouldProcessFile(".classy/output.html", ["node_modules"], ".classy");

      expect(result).toBe(false);
    });

    it("should handle null/undefined filePath", () => {
      const result = shouldProcessFile(null as unknown as string, ["node_modules"], ".classy");
    ...
    it("should handle filePath with multiple dots", () => {
      const result = shouldProcessFile("component.test.vue", ["node_modules"], ".classy");
