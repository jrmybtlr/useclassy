...
export default function useClassy(): Plugin {
    ...
    // Set to store all unique classes across all files
    ...
    return {
        ...
        transform(code: string, id: string) {
            ...
            // 
            // Create an output file that exports all generated classes as a module.
            // 
            ...
            // Create .gitignore file inside .classy directory
            ...
            const outputFilePath = path.join(outDir, 'output.classy.jsx');

            try {
                // Ensure the directory exists
                fs.mkdirSync(outDir, { recursive: true });

                // Create JSX content with a div for each variant class, wrapped in a parent div
