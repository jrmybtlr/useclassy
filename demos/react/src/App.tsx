    ...
    >
      ...
      >
        ...
        <Case
          ...
          detail="className:@md — drag the box; padding/text grow when the container is ≥28rem."
        >
        ...
        <Case
          title="Named group"
          detail='className:group-hover/item — hover the card (group/item), not only this row.'
        >
