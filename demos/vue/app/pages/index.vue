  ...
  <section class="mx-auto flex w-full max-w-4xl bg-neutral-950">
    ...
    >
      ...
      >
        ...
        <h1
          class="text-tight mt-4 w-full text-center font-display text-3xl leading-[1em] font-semibold tracking-[-0.03em] text-balance"
          class:sm="text-4xl"
          class:md="text-[56px]"
        >
        ...
        <p
          class="mt-4 max-w-[42ch] text-center text-xl/normal tracking-tight text-balance text-neutral-400"
        >
        ...
        <div class="mt-8 flex flex-wrap items-center justify-center gap-4">
          ...
          <NuxtLink
            to="/docs"
            class="inline-flex items-center font-display text-lg text-neutral-400"
        ...
        <div class="mt-12 min-w-0" class:sm="mt-16">
          ...
          >
            <CodeBlock filename="vite.config.ts" :copy-text="viteCopy">
              <code>
                ...
                <div v-if="cssEngine === 'unocss'" class="ml-12 text-white">engine: 'unocss',</div>
          ...
          >
            ...
            <Callout>
              ...
              <span class="font-mono text-neutral-200">hover:…</span>
              classes when UseClassy runs first. The HTML manifest is a backstop for files Uno does
              not extract (plain
